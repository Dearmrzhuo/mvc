...
function content_5f49f0993f9881_57272081 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
...
">
            ...
            <div class="form-group">
                <label for="ctitle">目前内容图片</label><span class="displaynone" style="display: none;">:无</span><br>
                <img src="<?php echo $_smarty_tpl->tpl_vars['data']->value['imgurl'];?>
" alt="" id="#imgDisplay">
            </div>
            <div class="form-group">
                <label for="ctitle">上传图片<span style="font-size: 10px;color: gray">（如果不需要更换，请不要上传图片）</span></label>
                <div class="upload">
                </div>
