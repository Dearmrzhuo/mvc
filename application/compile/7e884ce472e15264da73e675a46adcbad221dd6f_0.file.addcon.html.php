...
function content_5f4895bf3daae9_82247177 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
...
<!--                <textarea name="conts" id="conts" class="form-control" rows="4"></textarea>-->
                <textarea id="conts" name="conts">Hello, World!</textarea>
            </div>
