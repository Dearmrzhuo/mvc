...
function content_5f3ff3fce8f3f7_68781282 (Smarty_Internal_Template $_smarty_tpl) {
?><!doctype html>
<html lang="en">
    ...
    <div class="box-con" style="width: 450px;">
        ...
        <form class="form-horizontal" action="admin/index/login" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="password" class="form-control" style="width: 45%;" id="code" placeholder="验证码" name="code">
                    <img src="http://localhost:81/server/laomeng/8.20mvcback/mvc/index.php/admin/index/mcode" style="position: absolute; right: 10px;top: 0;" onclick="this.src='http://localhost:81/server/laomeng/8.20mvcback/mvc/index.php/admin/index/mcode?'+Math.random()">
                </div>
            </div>
            <div class="form-group">
